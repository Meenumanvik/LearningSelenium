# Selenium Learning Guide with example
Author - Meenu Kumari
...
1. Clone the repository:
   ```sh
   git clone https://github.com/meenukumari/selenium-learning-guide.git
   ```
...
- LinkedIn: [Your Profile](https://linkedin.com/in/meenukumari)
- GitHub: [Your GitHub](https://github.com/meenukumari)